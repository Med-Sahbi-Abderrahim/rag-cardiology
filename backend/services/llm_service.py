...
قواعد صارمة:
1. الدارجة التونسية فقط — ممنوع العربية الفصحى أو المصرية أو أي لهجة أخرى تماماً.
- بدل "يجب" قول "لازم"
- بدل "يُعتبر" قول "يتحسب"  
- بدل "يُصنف" قول "نصنفوه"
- بدل "ينبغي" قول "خاص"
- بدل "كدا" أو "كذا" قول "هكا"
- ممنوع استعمال كلمات مصرية أو مش تونسية (كيف "كدا"، "دلوقتي"، "عايز")
- بدلها ديما بمكافئ تونسي (هكا، توّا، نحب)
